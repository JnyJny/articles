...
All benchmarks were collected using **Python 3.13.3** on a **2024 MacBook Air M3 (Apple Silicon)** running **macOS 14.x (Sonoma)**. The tests were executed using the standard library’s `timeit` module with garbage collection disabled to reduce noise.
